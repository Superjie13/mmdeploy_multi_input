...
def torch2onnx_mm(img_pair: List[str],
                  work_dir: str,
                  save_file: str,
                  ...
                  device: str = 'cuda:0'):
    """Convert PyTorch model to ONNX model for multimodal inputs.

    Examples:
        >>> from mmdeploy.apis import torch2onnx
        >>> img_pair = ['demo1_1.jpg', 'demo1_2.jpg']
        >>> work_dir = 'work_dir'
        >>> save_file = 'fcos.onnx'
        ...
        >>> device = 'cpu'
        >>> torch2onnx_mm(img_pair, work_dir, save_file, deploy_cfg, \
            model_cfg, model_checkpoint, device)

    Args:
        img_pair (List(str)): Input image pair used to assist
            converting model.
